...
var GuestService = /** @class */ (function () {
    ...
    GuestService.prototype.saveGuests = function (newGuests) {
        var _this = this;
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/guest", newGuests)
            .subscribe(function (response) {
            _this.guests = response.guestsAdded;
            _this.guestsUpdated.next(_this.guests.slice());
        });
    };
    GuestService.prototype.addExtraGuests = function (newGuests) {
        var _this = this;
        this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + "/guest/extra", newGuests)
            .subscribe(function (response) {
...
/***/ "./src/app/admin/add-guests/add-guests.component.css":
/*!***********************************************************!*\
  !*** ./src/app/admin/add-guests/add-guests.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FkbWluL2FkZC1ndWVzdHMvYWRkLWd1ZXN0cy5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/admin/add-guests/add-guests.component.html":
/*!************************************************************!*\
  !*** ./src/app/admin/add-guests/add-guests.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/add-guests/add-guests.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/admin/add-guests/add-guests.component.ts ***!
  \**********************************************************/
...
var AddGuestsComponent = /** @class */ (function () {
    ...
    AddGuestsComponent.prototype.addExtraGuests = function () {
    ...
    AddGuestsComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptions.push(this.guestService.guestsUpdatedListener().subscribe(function (updatedGuests) {
            _this.databaseGuests = updatedGuests;
            _this.numGuests = _this.databaseGuests.length;
        }));
    ...
    AddGuestsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./add-guests.component.html */ "./src/app/admin/add-guests/add-guests.component.html"),
            styles: [__webpack_require__(/*! ./add-guests.component.css */ "./src/app/admin/add-guests/add-guests.component.css")]
        }),
        __metadata("design:paramtypes", [_services_guest_service__WEBPACK_IMPORTED_MODULE_1__["GuestService"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
    ], AddGuestsComponent);
...
var AdminService = /** @class */ (function () {
    function AdminService(http, messageService, loadingService) {
        this.http = http;
        this.messageService = messageService;
        this.loadingService = loadingService;
        this.reportData = [];
        this.reportDataListener = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
    }
    AdminService.prototype.runRsvpReport = function () {
        var _this = this;
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + "/report/rsvp")
            .subscribe(function (response) {
            _this.reportData = response.results;
            _this.reportDataListener.next(_this.reportData);
        });
    };
    AdminService.prototype.getReportDataListener = function () {
    ...
    AdminService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _services_message_service__WEBPACK_IMPORTED_MODULE_2__["MessageService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"]])
    ], AdminService);
    return AdminService;
}());
...
module.exports = "table {\r\n    word-wrap: break-word;\r\n}\r\nli {\r\n    list-style: none;\r\n}\r\n.table td {\r\n    text-align: center;   \r\n}\r\n.table th {\r\n    text-align: center;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/admin/reports/rsvp/rsvp-report.component.html":
/*!***************************************************************!*\
  !*** ./src/app/admin/reports/rsvp/rsvp-report.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/reports/rsvp/rsvp-report.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/admin/reports/rsvp/rsvp-report.component.ts ***!
  \*************************************************************/
/*! exports provided: RsvpReportComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RsvpReportComponent", function() { return RsvpReportComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var RsvpReportComponent = /** @class */ (function () {
    function RsvpReportComponent(adminService) {
        this.adminService = adminService;
        this.reportData = {};
        this.subscriptions = [];
    }
    RsvpReportComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.runRsvpReport();
        this.subscriptions.push(this.adminService.getReportDataListener().subscribe(function (results) {
            if (results) {
                results.reportData.sort(function (a, b) {
    ...
    RsvpReportComponent.prototype.ngOnDestroy = function () {
        this.unsubscribe();
    };
    RsvpReportComponent.prototype.unsubscribe = function () {
        this.subscriptions.forEach(function (s) {
            s.unsubscribe();
        });
    };
    RsvpReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-rsvp',
            template: __webpack_require__(/*! ./rsvp-report.component.html */ "./src/app/admin/reports/rsvp/rsvp-report.component.html"),
            styles: [__webpack_require__(/*! ./rsvp-report.component.css */ "./src/app/admin/reports/rsvp/rsvp-report.component.css")]
        }),
        __metadata("design:paramtypes", [_admin_service__WEBPACK_IMPORTED_MODULE_1__["AdminService"]])
    ], RsvpReportComponent);
    return RsvpReportComponent;
}());
